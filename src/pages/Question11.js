      ...
      <div className="w-full max-w-screen-sm bg-gray h-screen pb-10">
        ...
        <div className="px- mt-4">
          ...
          <div className="mt-5">
            ...
            >
              {quizData[10]?.answers?.answer_a !== null && (
                <div className="bg-white py-5 px-3 rounded-lg">
                  <label className="container">
                    <p>{quizData[10]?.answers?.answer_a}</p>
                    <input
                      type="radio"
                      name="radio"
                      onClick={() =>
                        handleAnswerClick(
                          quizData[10]?.correct_answers?.answer_a_correct
                        )
                      }
                    />
              ...
              {quizData[10]?.answers?.answer_b !== null && (
                <div className="bg-white py-5 px-3 rounded-lg">
                  <label className="container">
                    <p>{quizData[10]?.answers?.answer_b}</p>
                    <input
                      type="radio"
                      name="radio"
                      onClick={() =>
                        handleAnswerClick(
                          quizData[10]?.correct_answers?.answer_b_correct
                        )
                      }
                    />
                    <span className="checkmark"></span>
              ...
              {quizData[10]?.answers?.answer_c !== null && (
                <div className="bg-white py-5 px-3 rounded-lg">
                  <label className="container">
                    <p>{quizData[10]?.answers?.answer_c}</p>
                    <input
                      type="radio"
                      name="radio"
                      onClick={() =>
                        handleAnswerClick(
                          quizData[10]?.correct_answers?.answer_c_correct
                        )
                      }
                    />
                    <span className="checkmark"></span>
              ...
              {quizData[10]?.answers?.answer_d !== null && (
                <div className="bg-white py-5 px-3 rounded-lg">
                  <label className="container">
                    <p>{quizData[10]?.answers?.answer_d}</p>
                    <input
                      type="radio"
                      name="radio"
                      onClick={() =>
                        handleAnswerClick(
                          quizData[10]?.correct_answers?.answer_d_correct
                        )
                      }
                    />
                    <span className="checkmark"></span>
