      ...
      <div className="w-full max-w-screen-sm bg-gray h-screen pb-10">
        ...
        <div className="px- mt-4">
          <div className="flex justify-between items-center px-4">
            ...
            <span>Question 12/{quizData.length}</span>
          </div>
          <div className="mt-5">
            <p className="bg-white py-4 px-3 shadow">
              {quizData[11]?.question}
            </p>
            <form
              key={quizData[11]?.id}
            ...
            >
              {quizData[11]?.answers?.answer_a !== null && (
                <div className="bg-white py-5 px-3 rounded-lg">
                  <label className="container">
                    <p>{quizData[11]?.answers?.answer_a}</p>
                    <input
                      type="radio"
                      name="radio"
                      onClick={() =>
                        handleAnswerClick(
                          quizData[11]?.correct_answers?.answer_a_correct
                        )
                      }
                    />
              ...
              {quizData[11]?.answers?.answer_b !== null && (
                <div className="bg-white py-5 px-3 rounded-lg">
                  <label className="container">
                    <p>{quizData[11]?.answers?.answer_b}</p>
                    <input
                      type="radio"
                      name="radio"
                      onClick={() =>
                        handleAnswerClick(
                          quizData[11]?.correct_answers?.answer_b_correct
                        )
                      }
                    />
                    <span className="checkmark"></span>
              ...
              {quizData[11]?.answers?.answer_c !== null && (
                <div className="bg-white py-5 px-3 rounded-lg">
                  <label className="container">
                    <p>{quizData[11]?.answers?.answer_c}</p>
                    <input
                      type="radio"
                      name="radio"
                      onClick={() =>
                        handleAnswerClick(
                          quizData[11]?.correct_answers?.answer_c_correct
                        )
                      }
                    />
                    <span className="checkmark"></span>
              ...
              {quizData[11]?.answers?.answer_d !== null && (
                <div className="bg-white py-5 px-3 rounded-lg">
                  <label className="container">
                    <p>{quizData[11]?.answers?.answer_d}</p>
                    <input
                      type="radio"
                      name="radio"
                      onClick={() =>
                        handleAnswerClick(
                          quizData[11]?.correct_answers?.answer_d_correct
                        )
                      }
                    />
                    <span className="checkmark"></span>
